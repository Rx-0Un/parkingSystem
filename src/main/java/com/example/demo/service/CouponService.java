...
public class CouponService {
    ...
    public int addRowByInfo(float coupon_amount, int coupon_count, String coupon_location, int coupon_usage_count, Date starting_time, Date ending_time, String coupon_situation) {
